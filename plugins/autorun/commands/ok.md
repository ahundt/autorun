---
description: Allow a blocked pattern in this session
---
...
- `permanent` / `perm` / `p`: unlimited for the rest of this session (does not persist across sessions)
...
- `/ar:ok rm permanent` — allow rm for the rest of this session
