...
# Writes an allow that persists across every future session, so it must be a human decision.
...
- `/ar:globalok rm perm` — allow rm across all sessions until cleared
