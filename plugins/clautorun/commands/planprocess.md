---
description: Full 11-step planning methodology with Wait Process
...
4. **Launch Explore Subagents**: Use the Task tool to launch parallel Explore subagents (up to 3) to efficiently understand:
...
8. **Describe Logic Flow**: Describe the logic flow as you go through the description.
...
- **code-architect agent**: For complex architectural planning decisions
- **code-explorer agent**: For deep analysis of existing feature implementations
- **Specialized agents**: Use code-reviewer, pr-test-analyzer agents when their descriptions match your needs
