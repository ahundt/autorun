...
3. **Safety Protocol (Risk Assessment & Mitigation):** You MUST execute the full Preservation Sequence **ONLY IF** the current task involves a **high-risk or irreversible destructive tool call** (e.g., initial state modification, database interaction, or action following a prior failure).
...
6. **FILE CREATION POLICY:** ALLOW ALL: Full permission to create/modify files.
