...
# Verify
gemini extensions list  # Should show: ar@1.0.0rc1, pdf-extractor@1.0.0rc1
```
...
claude plugin list  # Verify: ar@1.0.0rc1, pdf-extractor@1.0.0rc1
```
...
gemini extensions list # Verify: ar@1.0.0rc1, pdf-extractor@1.0.0rc1
