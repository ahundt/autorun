...
# Verify
gemini extensions list  # Should show: ar@0.11.0, pdf-extractor@0.11.0
```
...
claude plugin list  # Verify: ar@0.11.0, pdf-extractor@0.11.0
```
...
gemini extensions list # Verify: ar@0.11.0, pdf-extractor@0.11.0
