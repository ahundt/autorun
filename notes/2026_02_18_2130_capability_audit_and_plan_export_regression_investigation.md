...
### Phase 1: Setup & Environment Verification (Tasks 1-5)

1. **Create notes file**
   - **Filename**: `notes/2026_02_18_capability_audit_manual_and_automated_test_execution.md`
   - **Template**: Use structure from lines 619-688
...
### Phase 2: Manual Capability Testing (Tasks 6-16)
...
### Phase 4: Bug Fixes (Tasks 24-28)

24. **Fix README.md stage markers**
    - **Condition**: If test 17 or manual test 11 confirmed wrong markers
    - **File**: `README.md`
    - **Edits required**:
...
### Phase 5: Commit & Verify (Tasks 29-31)

29. **Commit all fixes** — Follow `/cr:gc` 17-step requirements
...
31. **Final verification and summary**
    - **Run all verification commands** (lines 880-896):
      ```bash
